...
interface EditorState {
  ...
  setActiveEditorTool: (tool: string, subTool?: string) => void;
...
export const useEditorStore = create<EditorState>((set, get) => ({
  ...
  activeEditorTool: 'cursor',
  activeEditorSubTool: undefined,
  ...
  setActiveEditorTool: (tool, subTool) => set({ activeEditorTool: tool, activeEditorSubTool: subTool }),
